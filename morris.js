...
(function() {
  ...
  Morris.Donut = (function(_super) {
    ...
    Donut.prototype.select = function(idx) {
      ...
      segment.select();
      row = this.data[idx];
      return this.setLabels(this.options.formatter(row.value, row), row.label, idx);
    };

    Donut.prototype.setLabels = function(label1, label2, idx) {
